...
const ModalCard = ({ bankName, fintechUseNo, tofintechno }) => {
  ...
  const genTransId = () => {
    ...
    let transId = "M202112341U" + countnum; //이용기과번호 본인것 입력
    return transId;
  };
  ...
  const deposit = () => {
    const option = {
      ...
      headers: {
        Authorization: `bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJNMjAyMTEyMzQxIiwic2NvcGUiOlsib29iIl0sImlzcyI6Imh0dHBzOi8vd3d3Lm9wZW5iYW5raW5nLm9yLmtyIiwiZXhwIjoxNjI5OTU4MDA5LCJqdGkiOiJmYzgxM2Q2Mi0yNDBkLTQ2Y2YtYjExYy0wZGI3MGVlY2JmZjYifQ.T9MmTWtaBHeWEYB2bTdo-QCE06sc0JlwmEx1vXS_cRs`,
      },
      data: {
        cntr_account_type: "N",
